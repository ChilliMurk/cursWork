...
import { REMEMBER_REHYDRATED, REMEMBER_PERSISTED } from "./action-types.mjs";
import { combineReducers } from 'redux';
export * from "./errors.mjs";
export * from "./types.mjs";
var rememberReducer = function rememberReducer(reducer) {
  var data = {
    state: {}
  };
...
var rememberEnhancer = function rememberEnhancer(driver, rememberedKeys, _temp) {
  ...
  var storeCreator = function storeCreator(createStore) {
    return function (rootReducer, preloadedState, enhancer) {
      ...
      var initialize = function initialize(store) {
        return init(store, rememberedKeys, {
          driver: driver,
          prefix: prefix,
          serialize: serialize,
