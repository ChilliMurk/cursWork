...
// import {Methodology, MethodologyPage} from '@/modules/user/methodology/components/MethodologyPage.tsx';
...
//                         <NavItem>
//                             <CustomNavLink
//                                 isActive={activeSection === 'myTeams'}
//                                 onClick={(e) => {
//                                     e.preventDefault();
//                                     handleSectionChange('myTeams');
//                                 }}
//                             >
//                                 <span className="nav-icon"><i className="fas fa-users"></i></span>
...
// common/components/userDashboard/UserDashboard.tsx
import {FC, useState} from 'react';
import {useNavigate} from 'react-router-dom';
import {useAppDispatch} from "@/common/hooks/useAppSelector.ts";
import {logout} from "@/store/reducers/authSlice.ts";
